...
if($filename == ""){
	mysqli_query($koneksi, "insert into transaksi values (NULL,'$tanggal','$jenis','$kategori',NULL,NULL,'$nominal','$keterangan','','$bank')")or die(mysqli_error($koneksi));
	...
	if(!in_array($ext,$allowed) ) {
		...
		mysqli_query($koneksi, "insert into transaksi values (NULL,'$tanggal','$jenis','$kategori',NULL,NULL,'$nominal','$keterangan','$file_gambar','$bank')");
		header("location:transaksi.php?alert=berhasil");
	}
}
