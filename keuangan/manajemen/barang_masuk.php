            ...
            <section class="col-lg-12">
                <div class="box box-info" style="border-top-color:#E38B29;">
                    ...
                    <div class="box-body">
                        ...
                        <!-- Modal -->
                        <form action="barang_masuk_add.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="table-datatable">
                                ...
                                <tbody>
                                    ...
                                    include '../koneksi.php';
                                    $no = 1;
                                    $data = mysqli_query($koneksi, "SELECT * FROM barang_masuk bm,barang b where bm.id_barang = b.id_barang ");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit_barang_<?php echo $d['id_masuk'] ?>">
                                                    <i class="fa fa-pencil"></i>
                                                </button>

                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus_barang_<?php echo $d['id_masuk'] ?>">
                                                ...
                                                <form action="barang_masuk_update.php" method="post" enctype="multipart/form-data">
                                                    <div class="modal fade" id="edit_barang_<?php echo $d['id_masuk'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label>Nama</label>
                                                                        <input type="hidden" name="id" required="required" class="form-control" placeholder="Nama Kategori .." value="<?php echo $d['id_masuk']; ?>">
                                                                        <select  type="text" name="nama" required="required" class="form-control " placeholder="Masukkan Nama Barang ..">
                                                                            <?php
                                                                            $ambil = mysqli_query($koneksi, "select * from barang");
                                                                            while ($fetch = mysqli_fetch_array($ambil)) {
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>qty</label>
                                                                        <input type="number" name="qty" required="required" class="form-control" value="<?php $d['qty']; ?>" placeholder="Jumlah Stok ..">
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label>Keterangan</label>
                                                                        <input type="text" name="keterangan" required="required" class="form-control" placeholder="Keterangan .." value="<?php $d['keterangan'] ?>">
                                                                    </div>
                                                ...
                                                <!-- modal hapus -->
                                                <div class="modal fade" id="hapus_barang_<?php echo $d['id_masuk'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                                                <a href="hapus_barang_masuk.php?id=<?php echo $d['id_masuk'] ?>" class="btn btn-primary">Hapus</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
