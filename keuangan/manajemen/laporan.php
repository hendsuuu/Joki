            ...
            <form method="get" action="">
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                    <br/>
                    <input type="submit" value="TAMPILKAN" class="btn btn-sm btn-block"style="background-color:#E38B29;color:white;">
                  </div>
        ...
        <div class="box box-info"style="border-top-color:#E38B29;">
          ...
          <div class="box-body">
            ...
            if(isset($_GET['tanggal_sampai']) && isset($_GET['tanggal_dari']) && isset($_GET['kategori'])){
              ...
              <div class="alert text-center" style="background-color:#E38B29;color:white;">
